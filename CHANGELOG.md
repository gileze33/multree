...
## [v0.11.1](https://github.com/gileze33/multree/compare/v0.11.0...v0.11.1)

### Merged

- docs: document apps, group-root MCP, and claude_workspace in the manifest reference [`#66`](https://github.com/gileze33/multree/pull/66)

## [v0.11.0](https://github.com/gileze33/multree/compare/v0.10.1...v0.11.0) - 2026-09-12

### Merged

- Add apps (non-repo process members) and group-root MCP wiring [`#65`](https://github.com/gileze33/multree/pull/65)

## [v0.10.1](https://github.com/gileze33/multree/compare/v0.10.0...v0.10.1) - 2026-09-11

### Merged

- Defer cmux workspace close to the end of destroy [`#64`](https://github.com/gileze33/multree/pull/64)

## [v0.10.0](https://github.com/gileze33/multree/compare/v0.9.0...v0.10.0) - 2026-09-07
...
- Add default_include for create's repo selection [`#50`](https://github.com/gileze33/multree/pull/50)

## [v0.8.0](https://github.com/gileze33/multree/compare/v0.7.0...v0.8.0) - 2026-07-10
...
- Add repo-scoped commands dispatched as `multree &lt;action&gt; &lt;group&gt; &lt;target&gt;` [`#46`](https://github.com/gileze33/multree/pull/46)

## [v0.6.0](https://github.com/gileze33/multree/compare/v0.5.0...v0.6.0) - 2026-06-02

### Merged

- Export MULTREE_NAME to hooks + {multree_name} template + 40-char cap [`#45`](https://github.com/gileze33/multree/pull/45)

## [v0.5.0](https://github.com/gileze33/multree/compare/v0.4.0...v0.5.0) - 2026-05-29

### Merged

- Add bash/zsh shell completion [`#44`](https://github.com/gileze33/multree/pull/44)
- Add repo-scoped generated variables (e.g. ports) [`#42`](https://github.com/gileze33/multree/pull/42)

## [v0.4.0](https://github.com/gileze33/multree/compare/v0.3.0...v0.4.0) - 2026-05-26

### Merged

- Parallelize multree list git probes via a bounded pool [`#39`](https://github.com/gileze33/multree/pull/39)
- Allow ${VAR} expansion in worktree_root and repos[*].path [`#37`](https://github.com/gileze33/multree/pull/37)

## [v0.3.0](https://github.com/gileze33/multree/compare/v0.2.0...v0.3.0) - 2026-05-18
